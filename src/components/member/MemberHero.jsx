...
export default function MemberHero({ userData, memberPoints, nextTierPoints, progressPct, onProfileOpen, setActiveTab }) {
  ...
  const localProgressPct = Math.min(100, Math.round((memberPoints / tierInfo.nextThreshold) * 100));
        ...
        <div className="lg:col-span-7 text-left space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-teal-100/80 text-xs md:text-sm max-w-lg leading-relaxed font-medium">
              Akses cepat seluruh layanan apotek eksklusif Anda di sini. Nikmati fasilitas VIP bebas antre, konsultasi prioritas, dan diskon langsung setiap penebusan obat.
            </p>
          </div>
          ...
          <div className="bg-teal-950/40 backdrop-blur-md border border-teal-900/40 rounded-2xl p-5 max-w-md">
            ...
            {pointsNeeded > 0 ? (
              ...
              <p className="text-[10px] text-emerald-400 flex items-center gap-1.5 leading-normal font-bold">
                🎉 Selamat! Anda telah mencapai tier tertinggi apotek kami!
              </p>
            )}
          </div>
